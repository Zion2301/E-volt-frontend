...
const Dashboard = () => {
  ...
  const handleRegisterEVOLT = () => {
    ...
    axios
      .post("/api/evtols/register", { serialNumber, state, batteryLevel, weight })
      .then((response) => {
    ...
    <div className="dashboard-container">
      ...
      <div className="top-div">
        ...
        <Card className="card">
          ...
          <TextField label="Serial Number" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, serialNumber: e.target.value })} />
          <TextField label="State" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, state: e.target.value })} />
          <TextField label="Battery Level" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, batteryLevel: e.target.value })} />
          <TextField label="Weight" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, weight: e.target.value })} />
          <Button className="button" onClick={handleRegisterEVOLT}>Register</Button>
        </Card>

        {/* Load Medication Card */}
        <Card className="card">
          ...
          <TextField label="Medication Name" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, name: e.target.value })} />
          <TextField label="Code" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, code: e.target.value })} />
          <TextField label="Weight" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, weight: e.target.value })} />
          <TextField label="Image URL" className="text-field" onChange={(e) => setMedicationData({ ...medicationData, image: e.target.value })} />
